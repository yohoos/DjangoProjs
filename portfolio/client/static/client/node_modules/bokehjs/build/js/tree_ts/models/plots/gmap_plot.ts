...
export var GMapPlot = (function(superClass) {
  ...
  GMapPlot.prototype.initialize = function(options) {
    ...
    if (!this.api_key) {
      return logger.error("api_key is required. See https://developers.google.com/maps/documentation/javascript/get-api-key for more information on how to obtain your own.");
    }
  };

  GMapPlot.prototype._init_plot_canvas = function() {
    return new GMapPlotCanvas({
      plot: this
    });
  };
