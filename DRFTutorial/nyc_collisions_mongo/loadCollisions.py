...
from nyc_collisions_mongo.models import Collision
...
def create_collision(row):
    ...
    record.time = str(datetime.strptime(row[2], '%H:%M').time())
...
if __name__ == "__main__":
    ...
    df = df.fillna('').loc[range(0,10000)]
    ...
    print
    print("Saving Begins ...")
    Collision.objects.insert(collisions)
